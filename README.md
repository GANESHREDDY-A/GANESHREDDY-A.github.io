   ...
   - Research Volunteer
     - Department of Bio Statistics, University at Buffalo
       - Buffalo, NY | May 2023 - Dec 2023
         - I worked with large genetic interaction datasets and built both 2D and 3D network visualizations to make complex relationships easier to explore and understand. 
           Along the way, I tested different visualization tools and refined layouts so the insights felt clearer and more intuitive.
   - Research Support Analyst
     - Microsoft Research, Infosys Limited (Contracted to Microsoft)
       - Hyderabad, India
         - I helped the IVR research team improve their system by preparing conversational datasets, analyzing call logs, and supporting testing cycles. 
           I also created quick summary reports and verified data quality so researchers had clean, reliable inputs for refining the model.
